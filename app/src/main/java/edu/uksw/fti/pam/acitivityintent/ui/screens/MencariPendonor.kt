    ...
    Column(
        ...
        Card(
            ...
            Column(
                ...
                Text(text = stringResource(id = R.string.penjelasan_1))
                ...
                Column(horizontalAlignment = Alignment.CenterHorizontally) {
                    Row(horizontalArrangement = Arrangement.Center,
                        modifier = Modifier
                            ...
                            .padding(top = 0.dp)
                            .padding(horizontal = 40.dp)){
                        Text(text = stringResource(id = R.string.kantong_darah), modifier = Modifier.padding(top = 15.dp))
                        ...
                        Popup(
                            ...
                            Surface(
                                ...
                                Column(
                                    ...
                                    Text(text = stringResource(id = R.string.penjelasan_2))
                                    Text(text = "Gol Darah  : A", fontSize = 20.sp, textAlign = TextAlign.Center)
                                    Text(text = "Jumlah     : 2", fontSize = 20.sp, textAlign = TextAlign.Center)
